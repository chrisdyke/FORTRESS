        ...
        <div class="rev_slider" data-version="5.0">
          <ul>
            ...
            <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg5.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
              ...
              <!-- LAYER NR. 1 -->
              <div class="tp-caption tp-resizeme text-uppercase text-black font-raleway"
                id="rs-1-layer-1"
                ...
                style="z-index: 7; white-space: nowrap; font-weight:700; color:#000;">Music Time
              </div>
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway bg-theme-colored-transparent border-left-theme-color-2-6px pl-20 pr-20"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:600;">That is our Profession 
              </div>
            ...
            <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg7.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
              ...
              <div class="tp-caption tp-resizeme text-uppercase  bg-theme-colored-transparent text-white font-raleway border-left-theme-color-2-6px border-right-theme-color-2-6px pl-30 pr-30"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:400; border-radius: 30px;">Passion for Music
              </div>
              ...
              <div class="tp-caption tp-resizeme text-uppercase bg-theme-colored-transparent text-white font-raleway pl-30 pr-30"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:700; border-radius: 30px;">A Name in Choir|Band Music
              </div>
            ...
            <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg1.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway bg-theme-colored-transparent border-right-theme-color-2-6px pr-20 pl-20"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:600;">Best Music School
              </div>
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:600;">Entertain, Edify and Educate 
              </div>
              ...
              <div class="tp-caption tp-resizeme text-white text-right" 
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 5; white-space: nowrap; letter-spacing:0px; font-weight:400;">We lead the frontiers in the promotion of choral performances and all forms of art music
              </div>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-8 col-sm-12 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              <h3 class="text-uppercase mt-0">Welcome To <span class="text-theme-color-2">  Chisado Music </span></h3>
              <p class="" style="font-family:Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', serif; font-size:14px;">CHISADO MUSIC is A Renowned name in Choir|Band Performance, Tutoring || Music Consultant || Music Production || Installation || Sound Engineering company in Nigeria. </p>
              <div class="row mt-40">
                <div class="col-md-6 wow fadeInUp" data-wow-duration="1s">
                  <div class="mb-sm-30">
                    <img class="img-fullwidth" src="images/7a.jpg" style="width:260px; height:210px;" alt="">
                    <h4 class="letter-space-1 mt-10">Sound Engineering|Installation of Musical Equipments  <span class="text-theme-color-2"> .</span></h4>
                    <p> We design and install a live music sound system for a various events, indoor and out door</p>
                    <a href="about.php" class="btn btn-sm btn-theme-colored">Read more</a>
                  </div>
                </div>
                <div class="col-md-6 wow fadeInUp" data-wow-duration="1.2s">
                  <div class="mb-sm-30">
                    <img class="img-fullwidth" src="images/band2.jpeg" style="width:260px; height:210px;" alt="">
                   
                    <h4 class=" letter-space-1 mt-10">Band Performance, Tutoring|Music Consultant|Music Production<span class="text-theme-color-2">.</span></h4>
                    <p> We are Committed to providing outstanding musical training for various performance. </p>
                    <a href="about.php" class="btn btn-sm btn-theme-colored">Read more</a>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4 col-sm-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
             <div class="p-30 bg-theme-colored mt-10">
                <h4 class="text-white mt-0 mb-10">Requesting Our Services ?</h4>
              <!-- Appilication Form Start-->
              <form id="reservation_form" name="reservation_form" class="reservation-form mt-20" method="post" action="#">
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group mb-20">
                      <input placeholder="Enter Name" type="text" id="reservation_name" name="names" required="" class="form-control">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group mb-20">
                      <input placeholder="Email" type="text" id="reservation_email" name="cemail" class="form-control" required="">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group mb-20">
                      <input placeholder="Phone" type="text" id="reservation_phone" name="cphone" class="form-control" required="">
                    </div>
                  </div>

                  <div class="col-sm-12">
                    <div class="form-group">
                      <textarea placeholder="Enter your Request here" rows="3" class="form-control required" name="msg" id="form_message" aria-required="true"></textarea>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group mb-20">
                      <input placeholder="Verification Code" type="text" id="reservation_email" name="code" class="form-control" required="">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group mb-20">
       <input placeholder="" type="text" id="capcha" value="" readonly name="capcha" class="form-control" required="">
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group mb-0 mt-10">
                      <input name="form_botcheck" class="form-control" type="hidden" value="">
  <button type="submit"  name="submit"class="btn btn-colored btn-default text-black btn-lg btn-block" data-loading-text="Please wait...">Submit Request</button>
                    </div>
                  </div>
                </div>
              </form>
